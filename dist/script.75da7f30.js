...
console.log(JSON.stringify(taskList)); // Submit Button Event Listener

var button = document.getElementById("submitTaskPress");
button.addEventListener("click", function () {
  var $taskName = document.getElementById("taskName").value;
  var $dueDate = document.getElementById("dueDate").value;
  var $eta = document.getElementById("etaInput").value;
  var $completionTime = document.getElementById("completionTimeInput").value;
  var $priority = document.getElementById("priorityInput").options[priorityInput.selectedIndex].value;
...
function renderTask(task) {
  ...
  var item = document.createElement; //Extra task DOM elements
